...
MSbuild TinyCLR\TinyCLR.proj /t:rebuild /p:flavor=%FLAVOR%;memory=flash /filelogger
GOTO :EOF
...
MSbuild TinyCLR\TinyCLR.proj /t:rebuild /p:flavor=%FLAVOR%;memory=flash;forcedat=%FORCEDAT% /filelogger
GOTO :EOF
