...
//  Implementation for the MountaineerUSB board (STM32F4): Copyright (c) Oberon microsystems, Inc.
//
//  Customized for MountaineerUSB board
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
#define BOOTER_BUTTON_PIN (4 * 16 + 10) // PE10

#define BOOTER_BLUE_LED_PIN (4 * 16 + 14)  // PE14
#define BOOTER_BLUE_LED_PWM PWM_CHANNEL_7
...
#if defined(TARGETLOCATION_RAM)
            CPU_GPIO_EnableOutputPin(BOOTER_BLUE_LED_PIN, TRUE);
#else
            PWM_Initialize(BOOTER_BLUE_LED_PWM);
            UINT32 p = 1000, d = 5;
            PWM_SCALE_FACTOR s = PWM_MILLISECONDS;
            PWM_ApplyConfiguration(BOOTER_BLUE_LED_PWM, BOOTER_BLUE_LED_PIN, p, d, s, FALSE);
            PWM_Start(BOOTER_BLUE_LED_PWM, BOOTER_BLUE_LED_PIN);
#endif
