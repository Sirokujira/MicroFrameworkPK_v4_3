...
{
    return RX63N_I2C_Driver::Initialize();
}

BOOL I2C_Internal_Uninitialize()
{
    return RX63N_I2C_Driver::Uninitialize();
}

void I2C_Internal_XActionStart(I2C_HAL_XACTION* xAction, bool repeatedStart)
{
    RX63N_I2C_Driver::MasterXAction_Start(xAction, repeatedStart);
}

void I2C_Internal_XActionStop()
{
    RX63N_I2C_Driver::MasterXAction_Stop();
}
...
{
    return RX63N_I2C_Driver::GetPins(scl, sda);
}
