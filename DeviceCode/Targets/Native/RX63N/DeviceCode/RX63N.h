...
extern RX63N_TIMER_Driver g_RX63N_TIMER_Driver;
...
extern RX63N_TIME_Driver g_RX63N_TIME_Driver;
...
struct RX63N_I2C_Driver
{
    ...
    static void RX63N_I2C_ICEEI_ISR(void);
    static void RX63N_I2C_ICRXI_ISR(void);
    static void RX63N_I2C_ICTXI_ISR(void);
    static void RX63N_I2C_ICTEI_ISR(void);
private:
};
