...
#define SCLPIN RX62N_GPIO::P12
#define SDAPIN RX62N_GPIO::P13
...
RX62N_I2CSW_Driver g_RX62N_I2CSW_Driver;

BOOL RX62N_I2CSW_Driver::Initialize()
{
    NATIVE_PROFILE_HAL_PROCESSOR_I2C();
    g_RX62N_I2CSW_Driver.m_currentXAction = NULL;
    g_RX62N_I2CSW_Driver.m_currentXActionUnit = NULL;
    i2c_init();
...
BOOL RX62N_I2CSW_Driver::Uninitialize()
{
    NATIVE_PROFILE_HAL_PROCESSOR_I2C();
    g_RX62N_I2CSW_Driver.m_currentXAction = NULL;
    g_RX62N_I2CSW_Driver.m_currentXActionUnit = NULL;
...
void RX62N_I2CSW_Driver::Abort(void)
{
    I2C_HAL_XACTION *xAction = g_RX62N_I2CSW_Driver.m_currentXAction;
    i2c_stopbit();
    xAction->Signal(I2C_HAL_XACTION::c_Status_Aborted);
}

void RX62N_I2CSW_Driver::WriteToSubordinate(I2C_HAL_XACTION_UNIT *unit)
{
    UINT8 *queueData;
...
void RX62N_I2CSW_Driver::ReadFromSubordinate(I2C_HAL_XACTION_UNIT *unit)
{
    UINT8* queueData;
...
void RX62N_I2CSW_Driver::MasterXAction_Start(I2C_HAL_XACTION* xAction, bool repeatedStart)
{
    UINT8 address;
    NATIVE_PROFILE_HAL_PROCESSOR_I2C();
    g_RX62N_I2CSW_Driver.m_currentXAction = xAction;
    g_RX62N_I2CSW_Driver.m_currentXActionUnit = xAction->m_xActionUnits[xAction->m_current++];
    I2C_HAL_XACTION_UNIT *unit = g_RX62N_I2CSW_Driver.m_currentXActionUnit;
#ifdef DEBUG_I2CSW
    ...
    address |= unit->IsReadXActionUnit() ? RX62N_I2CSW_Driver::c_DirectionRead : RX62N_I2CSW_Driver::c_DirectionWrite;
...
void RX62N_I2CSW_Driver::MasterXAction_Stop()
{
    NATIVE_PROFILE_HAL_PROCESSOR_I2C();
#ifdef DEBUG_I2CSW
...
void RX62N_I2CSW_Driver::GetClockRate(UINT32 rateKhz, UINT8& clockRate, UINT8& clockRate2)
{
}

void RX62N_I2CSW_Driver::GetPins(GPIO_PIN& scl, GPIO_PIN& sda)
{
    NATIVE_PROFILE_HAL_PROCESSOR_I2C();
    scl = SCLPIN;
    sda = SDAPIN;
