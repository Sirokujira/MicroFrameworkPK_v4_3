...
{
    return RX62N_I2CSW_Driver::Initialize();
}

BOOL I2C_Internal_Uninitialize()
{
    return RX62N_I2CSW_Driver::Uninitialize();
}

void I2C_Internal_XActionStart(I2C_HAL_XACTION* xAction, bool repeatedStart)
{
    RX62N_I2CSW_Driver::MasterXAction_Start(xAction, repeatedStart);
}

void I2C_Internal_XActionStop()
{
    RX62N_I2CSW_Driver::MasterXAction_Stop();
}

void I2C_Internal_GetClockRate(UINT32 rateKhz, UINT8& clockRate, UINT8& clockRate2)
{
    RX62N_I2CSW_Driver::GetClockRate(rateKhz, clockRate, clockRate2);
}

void I2C_Internal_GetPins(GPIO_PIN& scl, GPIO_PIN& sda)
{
    return RX62N_I2CSW_Driver::GetPins(scl, sda);
}
