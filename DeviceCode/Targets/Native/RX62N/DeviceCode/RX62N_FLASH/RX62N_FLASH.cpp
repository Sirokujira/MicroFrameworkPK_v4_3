...
BOOL RX62N_BS_Driver::ChipInitialize(void *context)
{   
...
BOOL RX62N_BS_Driver::ChipUnInitialize(void *context)
{
#if defined(DEBUG_FLASH)
...
BOOL RX62N_BS_Driver::ChipReadOnly(void *context, BOOL On, UINT32 ProtectionKey)
{
#if defined(DEBUG_FLASH)
...
const BlockDeviceInfo* RX62N_BS_Driver::GetDeviceInfo(void *context)
{
#if defined(DEBUG_FLASH)
...
BOOL RX62N_BS_Driver::Read(void *context, ByteAddress Address, UINT32 NumBytes, BYTE *pSectorBuff)
{
...
BOOL RX62N_BS_Driver::Write(void *context, ByteAddress Address, UINT32 NumBytes, BYTE *pSectorBuff, BOOL ReadModifyWrite)
{
...
BOOL RX62N_BS_Driver::WriteX(void *context, ByteAddress Address, UINT32 NumBytes, BYTE *pSectorBuff, BOOL ReadModifyWrite, BOOL fIncrementDataPtr)
{
...
BOOL RX62N_BS_Driver::Memset(void *context, ByteAddress Address, UINT8 Data, UINT32 NumBytes)
{
...
BOOL RX62N_BS_Driver::GetSectorMetadata(void *context, ByteAddress SectorStart, SectorMetadata *pSectorMetadata)
{
#if defined(DEBUG_FLASH)
...
BOOL RX62N_BS_Driver::SetSectorMetadata(void *context, ByteAddress SectorStart, SectorMetadata *pSectorMetadata)
{
#if defined(DEBUG_FLASH)
...
BOOL RX62N_BS_Driver::IsBlockErased(void *context, ByteAddress Address, UINT32 BlockLength)
{
#if defined(DEBUG_FLASH)
...
// erase one page
BOOL RX62N_BS_Driver::EraseBlock(void *context, ByteAddress Address)
{
...
void RX62N_BS_Driver::SetPowerState(void *context, UINT32 State)
{
#if defined(DEBUG_FLASH)
...
UINT32 RX62N_BS_Driver::MaxSectorWrite_uSec(void *context)
{
#if defined(DEBUG_FLASH)
...
UINT32 RX62N_BS_Driver::MaxBlockErase_uSec(void *context)
{
#if defined(DEBUG_FLASH)
...
struct IBlockStorageDevice g_RX62N_INTERNALFLASH_DeviceTable =
{
    &RX62N_BS_Driver::ChipInitialize,
    &RX62N_BS_Driver::ChipUnInitialize,
    &RX62N_BS_Driver::GetDeviceInfo,
    &RX62N_BS_Driver::Read,
    &RX62N_BS_Driver::Write,
    &RX62N_BS_Driver::Memset,
    &RX62N_BS_Driver::GetSectorMetadata,
    &RX62N_BS_Driver::SetSectorMetadata,
    &RX62N_BS_Driver::IsBlockErased,
    &RX62N_BS_Driver::EraseBlock,
    &RX62N_BS_Driver::SetPowerState,
    &RX62N_BS_Driver::MaxSectorWrite_uSec,
    &RX62N_BS_Driver::MaxBlockErase_uSec,
};
