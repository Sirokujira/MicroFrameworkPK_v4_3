...
#define RX62N_MAX_GPIO_PINS    136
#define RX62N_MAX_GPIO_PORTS    (RX62N_MAX_GPIO_PINS/8)
...
//extern RX62N_Driver g_RX62N_Driver;
...
extern RX62N_TIMER_Driver g_RX62N_TIMER_Driver;
...
extern RX62N_TIME_Driver g_RX62N_TIME_Driver;
...
extern RX62N_USART_Driver g_RX62N_USART_Driver;
...
#define RX62N_GPIO_POLLING_INTERVAL 5000
...
struct RX62N_GPIO_Driver
{
    ...
    static const UINT32 c_MaxPins = RX62N_MAX_GPIO_PINS;
    static const UINT32 c_MaxPorts = RX62N_MAX_GPIO_PORTS;
    ...
    //static const UINT8 c_GPIO_ResistorMode;
    //static const UINT8 c_GPIO_InterruptMode;
...
//extern RX62N_GPIO_Driver g_RX62N_GPIO_Driver;
...
//extern RX62N_SPI_Driver g_RX62N_SPI_Driver;
...
struct RX62N_I2C_Driver
{
    ...
    static void ReadLastByte(void);
    static void StopCondition(void);
    static void Abort(void);

    static void RX62N_I2C_ICEEI_ISR(void);
    static void RX62N_I2C_ICRXI_ISR(void);
    static void RX62N_I2C_ICTXI_ISR(void);
    static void RX62N_I2C_ICTEI_ISR(void);
private:
};

//extern RX62N_I2C_Driver g_RX62N_I2C_Driver;

//
// I2C driver
//////////////////////////////////////////////////////////////////////////////

struct RX62N_I2CSW_Driver
{
    static const UINT8 c_DirectionRead = 1;
    static const UINT8 c_DirectionWrite = 0;
    I2C_HAL_XACTION *m_currentXAction;
...
struct RX62N_WATCHDOG_Driver

{
};

//extern RX62N_WATCHDOG_Driver g_RX62N_WATCHDOG_Driver;
