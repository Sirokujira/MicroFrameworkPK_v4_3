...
#ifndef _PLATFORM_EddyLinux_SELECTOR_H_
#define _PLATFORM_EddyLinux_SELECTOR_H_ 1

#define PLATFORM_EddyLinux_DEFINED
...
#endif // _PLATFORM_EddyLinux_SELECTOR_H_ 1
//
